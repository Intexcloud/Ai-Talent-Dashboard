...
('SELECT'),
('cf.*'),
('CASE WHEN bpn.iq_med IS NOT NULL AND cf.iq IS NOT NULL THEN LEAST(100.0'),
('CASE WHEN bpn.pauli_med IS NOT NULL AND cf.pauli IS NOT NULL THEN LEAST(100.0'),
('CASE WHEN bpn.faxtor_med IS NOT NULL AND cf.faxtor IS NOT NULL THEN LEAST(100.0'),
('CASE WHEN bpn.gtq_med IS NOT NULL AND cf.gtq IS NOT NULL THEN LEAST(100.0'),
('CASE WHEN bpn.tiki_med IS NOT NULL AND cf.tiki IS NOT NULL THEN LEAST(100.0'),
...
('SELECT'),
('t.*'),
('(COALESCE(tv_iq_match'),
('/ NULLIF((CASE WHEN tv_iq_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_pauli_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_faxtor_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_gtq_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_tiki_match IS NOT NULL THEN 1 ELSE 0 END)'),
('AS tgv_cognitive_match_rate'),
('(COALESCE(tv_ids_match'),
('/ NULLIF((CASE WHEN tv_ids_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_qdd_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_gdr_match IS NOT NULL THEN 1 ELSE 0 END)'),
('AS tgv_competency_match_rate'),
('(COALESCE(tv_papi_t_match'),
('/ NULLIF((CASE WHEN tv_papi_t_match IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN tv_strengths_match IS NOT NULL THEN 1 ELSE 0 END)'),
...
('employee_id'),
('ROUND( ('),
('COALESCE(fs.tgv_cognitive_match_rate'),
('COALESCE(fs.tgv_competency_match_rate'),
('COALESCE(fs.tgv_behavioral_match_rate'),
('COALESCE(fs.tgv_contextual_match_rate'),
(')::numeric / ('),
...
('END AS tgv_name'),
('tv.tv_name'),
('ROUND(tv.baseline_score::numeric'),
('ROUND(tv.user_score::numeric'),
('ROUND(tv.tv_match_rate::numeric'),
('ROUND(tv.tgv_match_rate::numeric'),
('FROM final_scores fs'),
...
('ORDER BY fb.final_match_rate DESC'),
('END;');
